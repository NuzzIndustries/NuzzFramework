...
namespace NuzzFramework.Utilities
{
    public static class EmbeddedResourceHelper
    {
        ...
        public static UnmanagedMemoryStream GetAssemblyResourceStream(string path)
        {
            ...
            return (UnmanagedMemoryStream)Configuration.AssetAssembly?.GetManifestResourceStream(fullname);
        }

        private static string GetFullResourceName(string path) => $"{Configuration.AssetAssembly.GetName().Name}.{path.Replace("/", ".")}";
